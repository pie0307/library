...
import pro.pie.me.basic.constant.SymbolConstant;
import pro.pie.me.basic.utils.Predef;
import pro.pie.me.httpclient.exception.HttpClientException;
import pro.pie.me.log.ApplicationLogger;
...
/**
 * 基于HttpCliet-4.2.1封装对远程HTTP接口的访问<br>
 *
...
public class HttpClientUtils {
    ...
    public final String httpGet(String url, Map<String, String> queryParams, int requestTimeout, String encoding) {
        ...
        try {
            ...
            ApplicationLogger.error("HttpClientUtils.httpGet error.", ex);
            ...
            ApplicationLogger.info(sb.toString());
        }
        return result;
    }
    ...
    public final String httpPostForm(String url, HeaderVO header, Map<String, String> postParams) {
        return httpPostForm(url, header, postParams, DEFAULT_REQUEST_TIMEOUT, DEFAULT_ENCODING);
    }
    ...
    public final String httpPostForm(String url, Map<String, String> postParams, int requestTimeout, String encoding) {
        ...
        return httpPostForm(url, null, postParams, requestTimeout, encoding);
    ...
    public final String httpPostForm(String url, HeaderVO headerVO, Map<String, String> postParams, int requestTimeout, String encoding) {
        ...
        try {
            ...
            if (headerVO != null) {
                if (headerVO.getCookieStore() != null) {
                    defaultHttpClient.setCookieStore(headerVO.getCookieStore());
                }
                if (Predef.size(headerVO.getHeaderList()) > 0)
                    for (Header header : headerVO.getHeaderList()) {
            ...
            ApplicationLogger.error("HttpClientUtils.httpPostForm error.", ex);
            sb.append("Exception:").append(ex.getMessage()).append(SymbolConstant.BAR);
    ...
    public final String httpPostJson(String url, String jsonParams, int requestTimeout, String encoding, HeaderVO headerVO) {
        ...
        try {
            ...
            ApplicationLogger.error("HttpClientUtils.httpPostJson error.", ex);
    ...
    public void setMaxPerRoute(int maxPerRoute) {
        ...
        poolingClientConnectionManager.setMaxTotal(maxPerRoute);
    }
    ...
    public void setMaxTotal(int maxTotal) {
        ...
        poolingClientConnectionManager.setDefaultMaxPerRoute(maxTotal);
    }
    ...
    private static class HttpRequestRetryHandler extends DefaultHttpRequestRetryHandler {
        ...
        public boolean retryRequest(IOException exception, int executionCount, HttpContext context) {
            ...
            if (exception instanceof NoHttpResponseException) {
                ApplicationLogger.info("HttpClientUtils.retryRequest detected NoHttpResponseException,sleep 1 ml,then retry");
                try {
